...
- `browser-sandbox.ts` - browser QuickJS execution runtime with edge fallback plus `aeon-logic` TLA sandbox runner integration and `gnosis-viz` workbench bundle fallback
